...
class Teacher(nn.Module):
    def __init__(
        ...
        self.sparse_encoder = Encoder(info, cfg["encoder"], encoder="sparse")
        self.dense_encoder = Encoder(info, cfg["encoder"], encoder="dense")
        ...
        print(f"teacher_policy.items() = {teacher_policy.items()}")
        print("##$#$#$#$#!$!@$@!#@%!#@%!!#@%#@%#@%#@#$#$@%!#@%#@%#@%!#@%#@%#!@%!#@%#@!%!@%!#")
        ...
        print(f"mlp_params 출력중!\n{mlp_params}")
        print("##$#$#$#$#!$!@$@!#@%!#@%!!#@%#@%#@%#@#$#$@%!#@%#@%#@%!#@%#@%#!@%!#@%#@!%!@%!#")
        print(f"encoder_params1 출력중!\n{encoder_params1}")
        print("##$#$#$#$#!$!@$@!#@%!#@%!!#@%#@%#@%#@#$#$@%!#@%#@%#@%!#@%#@%#!@%!#@%#@!%!@%!#")
        print(f"encoder_params2 출력중!\n{encoder_params2}")
        print("##$#$#$#$#!$!@$@!#@%!#@%!!#@%#@%#@%#@#$#$@%!#@%#@%#@%!#@%#@%#!@%!#@%#@!%!@%!#")
        
        # Load state dict
        self.MLP.load_state_dict(mlp_params)
        # print(self.sparse_encoder)
        # print(self.sparse_encoder.state_dict())
        # print("=================")
        self.sparse_encoder.load_state_dict(encoder_params1)
        # print(self.sparse_encoder)
        # print(self.sparse_encoder.state_dict())
        self.dense_encoder.load_state_dict(encoder_params2)
    ...
    def forward(self, x):
        ...
        e_l1 = self.encoder_sparse(sparse) # Pass exteroceptive information through encoder
        
        e_l2 = self.encoder_dense(dense)
