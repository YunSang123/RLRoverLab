...
class HeightmapManager():
    ...
    def mesh_to_heightmap(self, vertices, faces):
        ...
        print(f"max_x = {max_x}")
        print(f"max_y = {max_y}")
        print(f"resolution = {self.resolution_in_m}")
...
class TerrainManager():
    ...
    def __init__(self, num_envs: int, device: str):
        ...
        terrain_path = "/World/terrain/hidden_terrain/terrain"  # uneven ground
        # terrain_path = "/World/defaultGroundPlane"              # plane ground
        ...
        # print(f"self.meshes : {self.meshes.keys()}")
        vertices, faces = self.get_mesh(self.meshes["terrain"])  # ""안에 terrain이 원본임.
        # vertices, faces = self.get_mesh(self.meshes["terrain"])  # 원본 
        ...
        if device == 'cuda:0':
            ...
            # print(f"spawn_locations_final = {self.spawn_locations}")
    ...
    def random_rover_spawns(
        ...
        # num_envs가 100 미만이라면 n_spawns는 무조건 200
        ...
        for i in range(n_spawns):
            ...
            while not valid_location:
                ...
                if rock_mask[y, x] == 0:
                    ...
                    # print(f"spawn_locations[z] = {spawn_locations[i,2]}\n")
        ...
        # print(f"spawn_locations = {spawn_locations}\n")
